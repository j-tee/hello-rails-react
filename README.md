...
> Hello World is built using the Ruby on Rails framework and a react front-end designed to demonstrate the basic concepts of react-ruby integration
...
- git clone https://github.com/j-tee/hello-rails-react.git
